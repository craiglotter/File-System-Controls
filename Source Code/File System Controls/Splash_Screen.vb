...
#End Region
    ...
    Private Sub Splash_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Try
        '    If System.IO.File.Exists((Application.StartupPath & "\JungleNoise.wav").Replace("\\", "\")) = True Then
        '        Sound.PlayWaveFile("JungleNoise.wav")
        '    End If
        'Catch ex As Exception
        '    Error_Handler(ex, "Splash Screen Load")
        'End Try
        dataloaded = True
    End Sub
